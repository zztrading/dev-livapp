...
export const CardEffectBoundaryLine: React.FC<CardEffectProps> = ({ isActive, duration = 28 }) => {
...
const timerRef = useRef<NodeJS.Timeout[]>([]);
  ...
  return (
    <div className="relative w-full min-h-[520px] sm:min-h-[600px] h-[70vh] max-h-[700px] flex items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-red-950 via-rose-900 to-pink-950">
